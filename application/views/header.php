    ...
    <div class="main-wrapper">
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <img src="<?= base_url()?>image/logo_hond.png" alt="" width="60px">
          </div>
          </div>
          ...
          <?php if($_SESSION['role']=="Admin"){?>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="nav-link" href="<?php echo base_url('zakat')?>">Zakat</a></li>
                  <li><a class="nav-link" href="<?php echo base_url('laporan')?>">Laporan Penjualan</a></li>
