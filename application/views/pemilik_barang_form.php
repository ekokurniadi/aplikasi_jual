      ...
      <div class="col-12 col-md-12 col-lg-12">
        ...
        <form action="<?php echo $action; ?>" method="post" class="form-horizontal">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="pemilik_barang" id="pemilik_barang" placeholder="Pemilik Barang" value="<?php echo $pemilik_barang; ?>" />
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="color" class="form-control" name="warna" id="warna" placeholder="Warna" value="<?php echo $warna; ?>" />
                </div>
              </div>
